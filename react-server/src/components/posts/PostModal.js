            ...
            <div className="fixed inset-0 bg-gray-500 bg-opacity-70 transition-opacity -z-10" onClick={toggleModal}>
                ...
                <div className="fixed overflow-y-auto">
                    <div className='fixed bg-[#D9D9D9] top-[5%] left-[10%] w-[80%] h-[90%] rounded-3xl'>
                        ...
                        <div className='fixed bg-white h-[72%] w-[39%] top-[10%] left-[43%] -z-10 rounded-tr-2xl break-all overflow-y-scroll'>
                            <div className='fixed border-b-2 border-gray-200 bg-white  h-[13%] w-[39%] top-[10%] left-[43%] rounded-tr-2xl z-10'></div>
                            <img className="fixed h-16 w-16 object-cover rounded-full top-[12%] left-[48%] z-20" src={user_pfp || profile} alt="user's pfp"></img>
                            <div className='fixed left-[54%] top-28 font-bold text-md z-20'>{user_name}</div>
