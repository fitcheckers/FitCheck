            ...
            <div className="fixed inset-0 bg-gray-500 bg-opacity-70 transition-opacity -z-10" onClick={() => toggleModal()}>
                ...
                <div className="fixed overflow-y-auto">
                    <div className='fixed bg-[#D9D9D9] top-[5%] left-[14%] w-[75%] h-[90%] rounded-3xl inline-block'> 
                        ...
                        <img className='relative object-cover object-center top-[.5%] left-[6%] h-[81%] w-[34%] rounded-tl-2xl rounded-bl-2xl drop-shadow-lg border-white border-y-4 border-l-4' src={image_url} alt="user's post"></img>
                        <div className='fixed bg-white h-[70%] w-[39%] top-[12%] left-[44%] -z-10 rounded-tr-2xl rounded-br-2xl break-all'>
                            <div className='fixed border-b-2 border-gray-200 bg-white  h-[13%] w-[39%] top-[10%] left-[44%] rounded-tr-2xl z-10'></div>
                            ...
                            <form className='relative left-10 sm:left-12 top-[70%] bg-white border-black border-2 rounded-2xl h-[50px] w-[60%]'>
                                <input className='w-[100%] h-full rounded-2xl bg-inherit border-white' placeholder='Add a comment'></input>
